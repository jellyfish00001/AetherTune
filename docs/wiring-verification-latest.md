...
檢查時間：2026-09-20 16:33:27 +08:00

摘要：PASS=15；WAITING=6；BLOCKED=0

RunInferenceProbes：True；FailOnWaiting：True
...
| 角色模型（.pth/.index） | WAITING | 尚無角色模型；需先完成訓練、extraction、交接與 model-register 登記 |
...
| Project ONNX synthetic inference | WAITING | run_id=dd98038f-e57c-4aa4-ab8e-fd05bed36155; model_sha256=725cd4ff3a0858c5c738f2b07b5b469fa6708ef67f13c26aa7b8723dc5f1e0e5; inference 成功但實際 provider=CPUExecutionProvider（目前不是 CUDA）；requested=CUDAExecutionProvider; artifact=D:\AetherTune\artifacts\onnx-runtime-probe.json |
