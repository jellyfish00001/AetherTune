...
- 最新綜合唯讀檢查：`docs/wiring-verification-latest.md`，目前 `PASS=16 / WAITING=5 / BLOCKED=0`；WAITING 包含 4 組角色模型 register、VCClient embedded CUDA、Light Host Graillon chain、Voicemeeter B1 訊號與 ONNX CUDA provider。
