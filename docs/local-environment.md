...
- 最新綜合唯讀檢查：`docs/wiring-verification-latest.md`，目前 `PASS=16 / WAITING=4 / BLOCKED=1`；WAITING 包含 VCClient embedded CUDA、Light Host Graillon chain、Voicemeeter B1 訊號與 ONNX CUDA provider；唯一 BLOCKED 是四組角色模型 metadata／ready gate 未完成。
